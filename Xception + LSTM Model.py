...
# # Xception-LSTM Video Classification Model

# In[7]:


def Xception_lstm_model():
    
    pretrained_model = Xception(include_top=False, input_shape=(IMAGE_HEIGHT, IMAGE_WIDTH, 3))
