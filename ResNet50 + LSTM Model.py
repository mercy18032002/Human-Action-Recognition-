...
# # ResNet-LSTM Video Classification Model

# In[7]:


# Define a function for creating a ResNet50 + LSTM model
def resnet_lstm_model():
    # Load the pre-trained ResNet50 model without the top (fully connected) layers
    pretrained_model = ResNet50(include_top=False,input_shape=(IMAGE_HEIGHT , IMAGE_WIDTH,3))
    ...
    # Apply the pre-trained ResNet50 to each frame in the sequence
